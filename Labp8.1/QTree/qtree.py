import random
import matplotlib as plt #biblioteca para graficar
...
def subdivision_recursiva(nodo:Nodo, k:int):
    ...
    nodo.x1 = Nodo(nodo.x0,nodo.y0,w_,h_,nodo.particulas)
...
class QTree():
    ...
    def visualizacion(self):
        ...
        areas = set()
        for el in c:
            ptl.gcf().gca().add_patch(patches.Rectangle(n.x0,n.y0,n.ancho,n.alto,fill=False)) 
