...
def greet(**person):
    #======================================================
    # persona tiene caracteristicas firstname y lastename
    #======================================================
    print('Hello',person['firstname'], person['lastname'])
    
great(firstname='Steve', lastname= 'Jobs')
great(lastname='Jobs', firstname='Steve')
great(firstname='Bill', lastname='Gates', age=55) # Se puede pasar mas parametros de los necesarios 
...
greet() # Utiliza el valor dado de antenamo 
greet('Steve')
...
#=============================
# Funcion con varible global 
# EVITE EL EXCESO !!!!!!!
#=============================
name= 'Steve'
def greet():
    global name #Para utlizar una variable global (que viene de afuera del bloque)
    name='Bill'
    print('Hello', name)
