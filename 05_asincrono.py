...
if __name__ == "__main__":
    ...
    # loop de primero dimesion del arreglo
    for i in range(0,params.shape[0]):
        # Correr asinconicamente my_function con argumentos argsy cuando termine de correr get result
        pool.apply_async(my_function,args = (i,params[i,0], params[i,1],params[i,2]),callback=get_result)

        # Cerrar el grupo
        pool.close()
        # Esperar que termime el grupo
        pool.join()
