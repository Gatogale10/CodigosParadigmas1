...
#============================================
# Funcines abstractas dentro de funciones
...
temps = [("Berlin", 29), ("Cairo", 36), ("Buenos Aires", 19), ("Los Angeles",26), ("Tokyo",27), ("New York", 28),("Londres", 22), ("Penkin", 32),("Mexico Tenochtitlan", 23)]
